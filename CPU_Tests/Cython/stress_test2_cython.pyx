...
# func_process = multiprocess.Process(target=stress_test)
# func_process = multiprocessing.Process(target=monte_carlo_pi, args=(10**9,))
# func_process.start()
...
# # resource_process = multiprocess.Process(target=measure_resource_utilization, args=(process_id,))
